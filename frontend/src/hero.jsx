          ...
          <div className="flex flex-wrap gap-4">
            <a
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-[#3498DB] hover:bg-[#2980b9] text-white font-medium rounded-md transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  <svg
                ...
                <a
                  href="#footer"
                  className="px-6 py-3 bg-transparent border-2 border-white/40 hover:bg-white/10 text-white font-medium rounded-md transition-all duration-300"
                >
                  Contact Us
                </a>
              </div>
